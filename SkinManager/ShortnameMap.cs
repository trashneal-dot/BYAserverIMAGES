...
namespace SkengSkinManager
{
    ...
    public static class ShortnameMap
    {
        ...
        private static readonly (string sn, string[] names)[] CATALOG = new (string, string[])[]
        {
            ...
            ("lmg.m249",              new[]{ "M249" }),
            ("hmlmg",                 new[]{ "HMLMG" }),
            ("shotgun.spas12",        new[]{ "Spas-12 Shotgun", "SPAS-12", "Spas12" }),
            ...
            ("roadsign.jacket",       new[]{ "Roadsign Vest", "Road Sign Jacket", "Road Sign Vest" }),
            ("jacket",                new[]{ "Vagabond Jacket", "Jacket" }),
            ...
            ("roadsign.kilt",         new[]{ "Roadsign Pants", "Road Sign Kilt", "Roadsign Kilt" }),
            ...
            ("pants",                 new[]{ "Pants" }),
            ("burlap.trousers",       new[]{ "Burlap Pants", "Burlap Trousers" }),
            ("pants.shorts",          new[]{ "Shorts" }),
            ("attire.hide.pants",     new[]{ "Hide Pants" }),
            ("attire.hide.skirt",     new[]{ "Hide Skirt" }),
            ("shoes.boots",           new[]{ "Work Boots", "Boots" }),
            ("attire.hide.boots",     new[]{ "Hide Shoes", "Hide Boots" }),
